...
program
  ...
  .option('--preset <name>', 'style preset: basic, bold, highlight, box, pop', 'basic')
  .option('--font-size <size>', 'subtitle font size')
  .option('--margin-v <px>', 'bottom margin in pixels')
  .option('--outline <width>', 'outline thickness')
  .option('--color <hex>', 'text color, e.g. #FFFFFF')
  .option('--outline-color <hex>', 'outline color, e.g. #000000')
  .option('--bold', 'bold text')
  .option('--box', 'draw a translucent box behind the text')
  .option('--position <where>', 'bottom, middle or top', 'bottom')
