...
| 1 | app/app.js 분할 (preview/timeline/inspector/tools/state) | ✅ 완료 (format 분리) |
| 2 | 수동편집 재배치 (목업대로) | ✅ 완료 |
| 3 | 자동편집 탭 (6단계 + 자를 후보 확인) | ✅ 완료 |
| 4 | 자막 지우기 탭 (인페인팅, 9:16·16:9 모두) | ✅ 완료 |
| 5 | 에이전트 확대 + agent-gemini 추가 | ✅ 완료 |
| 6 | 릴리즈 v0.5.0 | ✅ 완료 v0.5.0 |
